...
/* Kein lv_disp_load_scr() hier - das Sauna-UI (ui_sauna.c) haengt
 * seinen Home-Screen direkt nach ui_init() rein. Wuerden wir hier
 * ui_screen_time laden, flackerte der alte Luftqualitaets-Screen
 * kurz vor dem Sauna-Home.                                         */
}
